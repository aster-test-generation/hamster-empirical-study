...
from hamster.extract_statistics.test_input.test_input_details import TestInputDetails
...
def statistics(
    ...
    if len(relevant_project_analyses) > 0:
        ...
        print()
        print("Generating statistics for assertions...")
        ...
        print("Assertion statistics generated!")

        print()
        print("Generating statistics for test inputs...")
        ...
        print("Test input statistics generated!")

        print()
        print("Generating statistics for test setups...")
        ...
        print("Test setup statistics generated!")

        print()
        print("Generating statistics for test teardowns...")
        ...
        print("Test teardown statistics generated!")

        print()
        print("Generating statistics for overall characteristics...")
        ...
        print("Overall characteristics statistics generated!")

        print()
        print("Generating statistics for test method sequences...")
        ...
        print("Test method sequence statistics generated!")
        
        print()
        print("Generating statistics for test method sequences per test scope...")
        ...
        print("Test method sequence per test scope statistics generated!")
