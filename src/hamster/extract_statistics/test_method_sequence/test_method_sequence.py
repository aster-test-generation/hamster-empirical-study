    ...
    def extract_details(self) -> dict | None | str:
            ...
            for project_analysis in p.track(self.all_project_analyses, total=len(self.all_project_analyses)):
                for test_class in project_analysis.test_class_analyses:
                    for test_method in test_class.test_method_analyses:
                        ...
                        cyclomatic_complexity_per_method.append(
                            test_method.cyclomatic_complexity_with_helpers if test_method.cyclomatic_complexity_with_helpers else 0)
                        top_ncloc.add(test_method.ncloc_with_helpers, test_method.method_signature,
        ...
        if self.output_format == OutputFormatType.JSON_PDF_FIGURES:
            ...
            self.extract_statistics_util.get_box_plot(elements=ncloc_per_method,
                                                      labels=['NCLOC'],
                                                      title='Box plot of NCLOC of test methods',
            ...
            self.extract_statistics_util.get_box_plot(elements=cyclomatic_complexity_per_method,
                                                      ...
                                                      title='Box plot of cyclomatic complexity of test methods',
                                                      filename='test_method_cyclomatic_complexity')
            self.extract_statistics_util.get_box_plot(elements=objects_created,
                                                      labels=['Objects created inside test method'],
                                                      title='Box plot of Objects created inside test method',
                                                      filename='test_method_objects_created')
            self.extract_statistics_util.get_box_plot(elements=mocks_created,
                                                      labels=['Mocking objects created inside test method'],
                                                      title='Box plot of mocking objects created inside test method',
        ...
        return {"ncloc_per_test_method": self.extract_statistics_util.get_summary_stats(ncloc_per_method),
                "cyclomatic_complexity_per_method": self.extract_statistics_util.get_summary_stats(
                    cyclomatic_complexity_per_method),
                "total_helper_methods": total_helper_methods,
                "total_helper_methods_ncloc": total_helper_methods_ncloc,
                "helper_method_distribution": self.extract_statistics_util.get_summary_stats(helper_methods),
                ...
                "mocks_created": self.extract_statistics_util.get_summary_stats(mocks_created) if len(mocks_created) > 0
                else None,
                "constructors_created": self.extract_statistics_util.get_summary_stats(constructor_called),
                "library_method_created": self.extract_statistics_util.get_summary_stats(library_called),
                "test_blocks": self.extract_statistics_util.get_summary_stats(test_blocks),
                "call_sequence_length": self.extract_statistics_util.get_summary_stats(call_sequence),
                ...
                "call_assertion_sequence_length": self.extract_statistics_util.get_summary_stats(assertion_sequence),
